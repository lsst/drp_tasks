...
class CountCellsAlongEdgesTestCase(unittest.TestCase):
    ...
    def test_validate_skymap_config_lsst_cells_v1(self):
        ...
        self.metadetection_shear_config.border = 0
    ...
    def test_validate_skymap_config_no_border_in_both_configs(self):
        """Test validation fails when border is 0 in task config and
        ...
        with self.assertRaises(
            InvalidQuantumError, msg="requires a positive border to be set either in the skymap config"
        ):
            task.validate_skymap_config(self.custom_skymap_config)
    ...
    def test_validate_skymap_config_border_in_both_configs(self):
        ...
        self.assertIn("requires a positive border to be set either in the skymap config", str(cm.exception))
    ...
    def test_validate_skymap_config_pixel_scale_mismatch(self):
        ...
        self.assertIn("tract overlap is insufficient given the borders", str(cm.exception))
